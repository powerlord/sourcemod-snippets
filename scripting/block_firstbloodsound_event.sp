...
public Plugin:myinfo = {
	...
	author			= "Powerlord",
	description		= "Block the First Blood sound (event version)",
	version			= VERSION,
...
public OnPluginStart()
{
	...
	HookEvent("teamplay_broadcast_audio", Event_BroadcastSound, EventHookMode_Pre);
}

public Action:Event_BroadcastSound(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (StrEqual(sound, "Announcer.AM_FirstBloodRandom") || StrEqual(sound, "Announcer.AM_FirstBloodFinally") || StrEqual(sound, "Announcer.AM_FirstBloodFast"))
	{
		return Plugin_Stop;
	}
